...
//uint32_t StartTime = micros();
  ...
  analog1.update(); g_DataSensors[1] = analog1.getValue() * g_ARef / 4096 * 1000;         
  analog2.update(); g_DataSensors[2] = analog2.getValue() * g_ARef / 4096 * 1000;
  analog3.update(); g_DataSensors[3] = analog3.getValue() * g_ARef / 4096 * 1000;
  analog4.update(); g_DataSensors[4] = analog4.getValue() * g_ARef / 4096 * 1000;      // Clip Temperature
  analog5.update(); g_DataSensors[5] = analog5.getValue() * g_ARef / 4096 * 1000;      // Board Temperature
